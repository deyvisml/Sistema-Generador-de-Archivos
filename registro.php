...
<html lang="en">
  <head>
    ...
    .izquierda{
        background: url(images/imagen-registro.jpg);
        ...
        <div class="derecha pt-2">
            ...
            <div class="mx-5 car ps-5 pe-5">
                <form class="row card-body validar-form" novalidate action="descargar.html">
                    ...
                    <div class="row g-1 ps-5 pe-5 pb-1" style="background-color:#F1F6F9;">
                        ...
                        <div class="row g-1 ps-5 pe-5 pb-1" style="background-color:#F1F6F9;">
                            ...
                            <div class="col-12 pt-2"> 
                                ...
                                <label for="fecha" class="form-label"><p class="fw-light m-0" style="font-size: 14px;"><span class="text-danger"> * </span>La longitud del nombre de usuario debe tener 15 caracteres como maximo y no puede incluir espacios</p></label>
                            </div>
               
                            <div class="col-6 pt-1 pe-2"> 
                    ...
                    <div class="text-center " style="background-color: #F1F6F9;">
                        <div class="boton">
